...
public class UnfairAdvertisementApplication extends Application {
    ...
    public void start(Stage window) {
        ...
        speeds.getData().add(new XYChart.Data("NDA", 80.0));
        speeds.getData().add(new XYChart.Data("Fastie", 40.0));
        speeds.getData().add(new XYChart.Data("SuperNet", 20.0));
        speeds.getData().add(new XYChart.Data("Meganet", 20.0));
